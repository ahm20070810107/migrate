...
import com.hitales.commons.enums.jpa.HibernateScannerWrapper;
...
public class ScanningCoordinator {
	...
	public void coordinateScan(
		...
		applyScanResultsToManagedResources(managedResources, wrapper, options, xmlMappingBinderAccess);
	}
